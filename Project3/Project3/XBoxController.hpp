...
namespace GamePad {
  ...
  class XBoxController {
    public:
	  ...
	  static GamePad::XBoxController * get();
	  ...
	  static const int MAX_THUMBSTICK_VAL = 32767;
	  static const int MIN_THUMBSTICK_VAL = -32768;
	  static const int MAX_TRIGGER_VAL = 255;
